...
(optional service)
If using the cloudflare cache or if you want to be sure that your articles are published on time You only need to activate the plugin services by the URL generated: https://vote-site.com/scheduled-posts-force?publish_missed_future_posts=true
